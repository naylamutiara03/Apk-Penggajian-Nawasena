...
<div class="p-6 lg:ml-[300px]">
    ...
    <div class="bg-white p-6 rounded shadow" id="laporan">
    ...
    <div class="mt-6 flex justify-between items-center no-print">
        ...
        <button onclick="window.print()" class="inline-block bg-green-600 hover:bg-green-700 text-white font-semibold py-2 px-4 rounded shadow">
            🖨 Cetak Laporan
        </button>
    </div>
</div>
